                        ...
                        <thead class="text-xs font-semibold uppercase text-gray-400 bg-gray-50">
                            <tr>
                                <th class="p-2 whitespace-nowrap">
                                    <div class="font-semibold text-right">الصورة</div>
                                </th>
                                <th class="p-2 whitespace-nowrap">
                                    <div class="font-semibold text-right">الإسم</div>
                                </th>
                                <th class="p-2 whitespace-nowrap">
                                    <div class="font-semibold text-right">السعر</div>
                                </th>
                                <th class="p-2 whitespace-nowrap">
                                    <div class="font-semibold text-right">العلامة التجارية</div>
                                </th>
                                <th class="p-2 whitespace-nowrap">
                                    <div class="font-semibold text-right">الوصف</div>
                                </th>
                                <th class="p-2 whitespace-nowrap">
                                    <div class="font-semibold text-right">الصنف</div>
                                </th>
                                <th class="p-2 whitespace-nowrap">
                        ...
                        <tbody class="text-sm divide-y divide-gray-100">
                            @forelse ( $results as $item )
                                <tr wire.loading.class.delay="opacity-50" wire:key="{{ $loop->index }}">
                                    ...
                                    <td class="p-2 whitespace-nowrap">
                                        <div class="font-medium text-gray-800">{{ $item['price'] }}</div>
                                    </td>
                                    <td class="p-2 whitespace-nowrap">
                                        <div class="font-medium text-gray-800">{{ $item['brand'] }}</div>
                                    </td>
                                    <td class="p-2 whitespace-nowrap">
                                        <div class="font-medium text-gray-800">{{ $item['category']['name'] }}</div>
                                    </td>
                                    <td class="p-2 whitespace-nowrap">
