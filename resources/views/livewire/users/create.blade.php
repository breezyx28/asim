...
<div class="flex flex-col h-auto bg-gray-100">
    ...
    <div class="grid place-items-center mx-2 my-20 sm:my-auto">
        ...
        <div
            ...
            <form class="mt-10" method="POST" action="{{ route('users.store') }}">
                @method('POST')
                @csrf

                <x-inputs.text-input id="username" name="username" placeholder="أكتب إسم المستخدم" type="text"
                    label="إسم المستخدم" required="true" />
                ...
                <x-inputs.text-input id="password" name="password" placeholder="إكتب كلمة السر" type="password"
                    label="كلمة السر" required="true" />
